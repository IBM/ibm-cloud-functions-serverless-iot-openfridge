...
* **人工智能模式：** 喜欢此模式？了解我们的其他 [AI 模式](https://developer.ibm.com/cn/technologies/artificial-intelligence/)。
* **数据分析模式：** 喜欢此模式？了解我们的其他[数据分析模式](https://developer.ibm.com/cn/technologies/data-science/)
